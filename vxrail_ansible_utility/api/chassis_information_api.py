...
class ChassisInformationApi(object):
    ...
    def v7_chassis_get(self, **kwargs):  # noqa: E501
        """Get a list of VxRail chassis (v7)  # noqa: E501

        Retrieves a list of VxRail chassis and information about the nodes in each chassis. Added vendor and model fields for witness NICS in v7.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v7_chassis_get(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :return: list[ChassisInfoV7]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.v7_chassis_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.v7_chassis_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def v7_chassis_get_with_http_info(self, **kwargs):  # noqa: E501
        """Get a list of VxRail chassis (v7)  # noqa: E501

        Retrieves a list of VxRail chassis and information about the nodes in each chassis. Added vendor and model fields for witness NICS in v7.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v7_chassis_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[ChassisInfoV7]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def v7_chassis_id_get(self, chassis_id, **kwargs):  # noqa: E501
        """Retrieves information about a user-specified chassis (v7)  # noqa: E501

        Retrieves information about the user-specified VxRail chassis. Added vendor and model fields for witness NICS in v7.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v7_chassis_id_get(chassis_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str chassis_id: Chassis ID (required)
        :return: ChassisInfoV7
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.v7_chassis_id_get_with_http_info(chassis_id, **kwargs)  # noqa: E501
        else:
            (data) = self.v7_chassis_id_get_with_http_info(chassis_id, **kwargs)  # noqa: E501
            return data

    def v7_chassis_id_get_with_http_info(self, chassis_id, **kwargs):  # noqa: E501
        """Retrieves information about a user-specified chassis (v7)  # noqa: E501

        Retrieves information about the user-specified VxRail chassis. Added vendor and model fields for witness NICS in v7.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v7_chassis_id_get_with_http_info(chassis_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v7_chassis_id_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'chassis_id' is set
        if ('chassis_id' not in params or
                params['chassis_id'] is None):
            raise ValueError("Missing the required parameter `chassis_id` when calling `v7_chassis_id_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ChassisInfoV7',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
