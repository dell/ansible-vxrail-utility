...
class CVSPublicApi(object):
    ...
    def v1_cvs_advisory_report_history(self, **kwargs):  # noqa: E501
        """Get advisor report history  # noqa: E501

        This API can retrieve previously generated advisor reports. The length of response list will be less than or equals to 30 and order by report_timestamp descending.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_cvs_advisory_report_history(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :return: list[ReportHistoryContent]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.v1_cvs_advisory_report_history_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.v1_cvs_advisory_report_history_with_http_info(**kwargs)  # noqa: E501
            return data

    def v1_cvs_advisory_report_history_with_http_info(self, **kwargs):  # noqa: E501
        """Get advisor report history  # noqa: E501

        This API can retrieve previously generated advisor reports. The length of response list will be less than or equals to 30 and order by report_timestamp descending.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_cvs_advisory_report_history_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method v1_cvs_advisory_report_history" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            response_type='list[ReportHistoryContent]',  # noqa: E501
    ...
    def v1_cvs_report_key_format(self, key, format, **kwargs):  # noqa: E501
        """Generate and download the advisor report.  # noqa: E501

        This API can generate and download the advisor report based on a encrypt key, with an option to choose between CSV or XLSX file formats.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_cvs_report_key_format(key, format, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str key: (required)
        :param str format: If you select CSV, the file will be split into multiple files and downloaded as a ZIP file. Selecting XLSX will produce a single file containing multiple tabs. (required)
        :return: str
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.v1_cvs_report_key_format_with_http_info(key, format, **kwargs)  # noqa: E501
        else:
            (data) = self.v1_cvs_report_key_format_with_http_info(key, format, **kwargs)  # noqa: E501
            return data

    def v1_cvs_report_key_format_with_http_info(self, key, format, **kwargs):  # noqa: E501
        """Generate and download the advisor report.  # noqa: E501

        This API can generate and download the advisor report based on a encrypt key, with an option to choose between CSV or XLSX file formats.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_cvs_report_key_format_with_http_info(key, format, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['key', 'format']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_cvs_report_key_format" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('key' not in params or
                params['key'] is None):
            raise ValueError("Missing the required parameter `key` when calling `v1_cvs_report_key_format`")  # noqa: E501
        # verify the required parameter 'format' is set
        if ('format' not in params or
                params['format'] is None):
            raise ValueError("Missing the required parameter `format` when calling `v1_cvs_report_key_format`")  # noqa: E501
        ...
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/zip', 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', 'application/json'])  # noqa: E501

        # Authentication setting
        auth_settings = ['basicAuth']  # noqa: E501

        return self.api_client.call_api(
            '/v1/cvs/report/{key}/{format}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def v1_generate_advisory_report_public(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :return: GenerateReportSuccessResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def v1_generate_advisory_report_public_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='GenerateReportSuccessResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def v1_lcm_advisory_meta_bundle_post_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['meta_bundle']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        form_params = []
        local_var_files = {}
        if 'meta_bundle' in params:
            local_var_files['meta_bundle'] = params['meta_bundle']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/lcm/advisory-meta-bundle', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
