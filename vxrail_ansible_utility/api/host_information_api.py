...
class HostInformationApi(object):
    ...
    def v10_hosts_get(self, **kwargs):  # noqa: E501
        ...
        New fields are added to v10 to distinguish between base storage and optional storage (vSphere 7.x only).  # noqa: E501
    ...
    def v12_hosts_get(self, **kwargs):  # noqa: E501
        ...
        New fields are added to v12 hosts, including the marketing name, GPU health, firmware version, and deployment_type.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
