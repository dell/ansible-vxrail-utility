...
class LCMUpgradeApi(object):
    ...
    def upgrade_v4(self, body, **kwargs):  # noqa: E501
        ...
        Perform a partial upgrade for all VxRail software and hardware. Version 4 of this API includes the optional property \"target_hosts\", which indicates the nodes to be upgraded. If \"target_hosts\" is empty or not provided, this API upgrades all nodes in the cluster.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
