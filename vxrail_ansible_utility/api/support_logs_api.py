...
class SupportLogsApi(object):
    ...
    def v1_support_logs_log_id_download_get(self, log_id, **kwargs):  # noqa: E501
        """Download the binary stream of a log  # noqa: E501

        Download the binary stream of a log.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_support_logs_log_id_download_get(log_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.v1_support_logs_log_id_download_get_with_http_info(log_id, **kwargs)  # noqa: E501
        else:
            (data) = self.v1_support_logs_log_id_download_get_with_http_info(log_id, **kwargs)  # noqa: E501
            return data

    def v1_support_logs_log_id_download_get_with_http_info(self, log_id, **kwargs):  # noqa: E501
        """Download the binary stream of a log  # noqa: E501

        Download the binary stream of a log.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_support_logs_log_id_download_get_with_http_info(log_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_support_logs_log_id_download_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('log_id' not in params or
            ...
            raise ValueError("Missing the required parameter `log_id` when calling `v1_support_logs_log_id_download_get`")  # noqa: E501
    ...
    def v1_support_logs_log_id_get(self, log_id, **kwargs):  # noqa: E501
        """Query the log by the log ID  # noqa: E501

        Query the log by the log ID.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_support_logs_log_id_get(log_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str log_id: the specific log user want to query (required)
        :return: LogInfo
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.v1_support_logs_log_id_get_with_http_info(log_id, **kwargs)  # noqa: E501
        else:
            (data) = self.v1_support_logs_log_id_get_with_http_info(log_id, **kwargs)  # noqa: E501
            return data

    def v1_support_logs_log_id_get_with_http_info(self, log_id, **kwargs):  # noqa: E501
        """Query the log by the log ID  # noqa: E501

        Query the log by the log ID.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_support_logs_log_id_get_with_http_info(log_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_support_logs_log_id_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'log_id' is set
        if ('log_id' not in params or
                params['log_id'] is None):
            raise ValueError("Missing the required parameter `log_id` when calling `v1_support_logs_log_id_get`")  # noqa: E501
