...
class SystemPreCheckApi(object):
    ...
    def v1_system_prechecks_id_result_get(self, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_system_prechecks_id_result_get(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: Request ID of the pre-check status that you want to query (required)
        :param bool verbose: Whether to return a full or simplified report. The default is true. Set to true to return a full pre-check result report. Set to false for a simplified report.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.v1_system_prechecks_id_result_get_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.v1_system_prechecks_id_result_get_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def v1_system_prechecks_id_result_get_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get a pre-check result  # noqa: E501

        Get a pre-check result using a specified request ID. Available reports include a status report from a currently running pre-check process or a report from previously run pre-check.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_system_prechecks_id_result_get_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_system_prechecks_id_result_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `v1_system_prechecks_id_result_get`")  # noqa: E501
    ...
    def v1_system_prechecks_precheck_service_version_get(self, **kwargs):  # noqa: E501
        """Get pre-check version  # noqa: E501

        Get the current version of the pre-check service in the VxRail system.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_system_prechecks_precheck_service_version_get(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.v1_system_prechecks_precheck_service_version_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.v1_system_prechecks_precheck_service_version_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def v1_system_prechecks_precheck_service_version_get_with_http_info(self, **kwargs):  # noqa: E501
        """Get pre-check version  # noqa: E501

        Get the current version of the pre-check service in the VxRail system.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_system_prechecks_precheck_service_version_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_system_prechecks_precheck_service_version_get" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def v1_system_prechecks_results_get(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_system_prechecks_results_get(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.v1_system_prechecks_results_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.v1_system_prechecks_results_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def v1_system_prechecks_results_get_with_http_info(self, **kwargs):  # noqa: E501
        """Get all pre-check reports  # noqa: E501

        Get a list of pre-check reports, which include the current running status and historical results.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_system_prechecks_results_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_system_prechecks_results_get" % key
                )
            params[key] = val
        del params['kwargs']
