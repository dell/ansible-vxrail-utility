...
class CertificatesApi(object):
    ...
    def v1_certificates_csr_post(self, body, **kwargs):  # noqa: E501
        ...
        Generate a CSR with the given information.  # noqa: E501
    ...
    def v1_trust_store_certificates_fingerprint_get(self, fingerprint, **kwargs):  # noqa: E501
        ...
        API to get the certificate content from the VxRail Manager trust store according to the fingerprint parameter.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
