...
class TrustStoreCertificatesInfoApi(object):
    ...
    def v1_trust_store_certificates_get(self, **kwargs):  # noqa: E501
        """Get the information of all the certificates in the trust store.  # noqa: E501

        API to get the information of all the certificates in the trust store.  # noqa: E501
    ...
    def v1_trust_store_certificates_get_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/trust-store/certificates', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
