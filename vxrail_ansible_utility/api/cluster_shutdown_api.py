...
class ClusterShutdownApi(object):
    ...
    def v1_cluster_shutdown_post(self, **kwargs):  # noqa: E501
        ...
        :param Body body: Perform an optional dry run to check whether it is safe to shut down. The default value is false.
        :return: RequestInfo
    ...
    def v1_requests_id_get(self, id, **kwargs):  # noqa: E501
        """Gets the status and progress of cluster shutdown.  # noqa: E501

        Gets the status and progress of cluster shutdown.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_requests_id_get(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.v1_requests_id_get_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.v1_requests_id_get_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def v1_requests_id_get_with_http_info(self, id, **kwargs):  # noqa: E501
        """Gets the status and progress of cluster shutdown.  # noqa: E501

        Gets the status and progress of cluster shutdown.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_requests_id_get_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_requests_id_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `v1_requests_id_get`")  # noqa: E501
