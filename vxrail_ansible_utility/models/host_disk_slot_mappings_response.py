...
class HostDiskSlotMappingsResponse(object):
    ...
    def host(self):
        ...
        If host_serial_number is supplied in the request object, this property returns the host serial number. Otherwise, the property returns the host ID address.  # noqa: E501
    ...
    def all_slots(self, all_slots):
        ...
        if all_slots is None:
            raise ValueError("Invalid value for `all_slots`, must not be `None`")  # noqa: E501
    ...
    def vsan_slots(self, vsan_slots):
        ...
        """
        if vsan_slots is None:
            raise ValueError("Invalid value for `vsan_slots`, must not be `None`")  # noqa: E501
    ...
    def non_vsan_slots(self, non_vsan_slots):
        ...
        :type: list[BayInfo]
        """
        if non_vsan_slots is None:
            raise ValueError("Invalid value for `non_vsan_slots`, must not be `None`")  # noqa: E501
    ...
    def diskgroup_type(self, diskgroup_type):
        ...
        :type: str
        """
        if diskgroup_type is None:
            raise ValueError("Invalid value for `diskgroup_type`, must not be `None`")  # noqa: E501
    ...
    def unmanaged_slots(self, unmanaged_slots):
        ...
        :type: list[BayInfo]
        """
        if unmanaged_slots is None:
            raise ValueError("Invalid value for `unmanaged_slots`, must not be `None`")  # noqa: E501
