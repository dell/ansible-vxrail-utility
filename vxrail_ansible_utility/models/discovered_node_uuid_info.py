...
class DiscoveredNodeUuidInfo(object):
    ...
    def __init__(self, host=None):  # noqa: E501
        """DiscoveredNodeUuidInfo - a model defined in Swagger"""  # noqa: E501
        self._host = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DiscoveredNodeUuidInfo, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DiscoveredNodeUuidInfo):
            return False
