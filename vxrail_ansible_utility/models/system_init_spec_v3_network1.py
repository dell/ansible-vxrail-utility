...
class SystemInitSpecV3Network1(object):
    ...
    def __init__(self, sfs=None, nic_profile=None, systemvm_portgroup_binding_type=None, management_portgroup_binding_type=None, vds=None):  # noqa: E501
        """SystemInitSpecV3Network1 - a model defined in Swagger"""  # noqa: E501
        self._sfs = None
    ...
    @property
    def sfs(self):
        """Gets the sfs of this SystemInitSpecV3Network1.  # noqa: E501


        :return: The sfs of this SystemInitSpecV3Network1.  # noqa: E501
        :rtype: SystemInitSpecV3Network1Sfs
        """
        return self._sfs

    @sfs.setter
    def sfs(self, sfs):
        """Sets the sfs of this SystemInitSpecV3Network1.


        :param sfs: The sfs of this SystemInitSpecV3Network1.  # noqa: E501
        :type: SystemInitSpecV3Network1Sfs
        """
    ...
    def nic_profile(self):
        """Gets the nic_profile of this SystemInitSpecV3Network1.  # noqa: E501

        The NIC profile configuration  # noqa: E501

        :return: The nic_profile of this SystemInitSpecV3Network1.  # noqa: E501
        :rtype: str
        """
    ...
    def nic_profile(self, nic_profile):
        """Sets the nic_profile of this SystemInitSpecV3Network1.

        The NIC profile configuration  # noqa: E501

        :param nic_profile: The nic_profile of this SystemInitSpecV3Network1.  # noqa: E501
        :type: str
        """
    ...
    def systemvm_portgroup_binding_type(self):
        """Gets the systemvm_portgroup_binding_type of this SystemInitSpecV3Network1.  # noqa: E501

        The type of portgroup binding for the system VMs  # noqa: E501

        :return: The systemvm_portgroup_binding_type of this SystemInitSpecV3Network1.  # noqa: E501
        :rtype: str
        """
    ...
    def systemvm_portgroup_binding_type(self, systemvm_portgroup_binding_type):
        """Sets the systemvm_portgroup_binding_type of this SystemInitSpecV3Network1.

        The type of portgroup binding for the system VMs  # noqa: E501

        :param systemvm_portgroup_binding_type: The systemvm_portgroup_binding_type of this SystemInitSpecV3Network1.  # noqa: E501
        :type: str
        """
    ...
    def management_portgroup_binding_type(self):
        """Gets the management_portgroup_binding_type of this SystemInitSpecV3Network1.  # noqa: E501

        The type of portgroup binding for the management server  # noqa: E501

        :return: The management_portgroup_binding_type of this SystemInitSpecV3Network1.  # noqa: E501
        :rtype: str
        """
    ...
    def management_portgroup_binding_type(self, management_portgroup_binding_type):
        """Sets the management_portgroup_binding_type of this SystemInitSpecV3Network1.

        The type of portgroup binding for the management server  # noqa: E501

        :param management_portgroup_binding_type: The management_portgroup_binding_type of this SystemInitSpecV3Network1.  # noqa: E501
        :type: str
        """
        allowed_values = ["STATIC_BINDING", "EPHEMERAL"]  # noqa: E501
    ...
    @property
    def vds(self):
        """Gets the vds of this SystemInitSpecV3Network1.  # noqa: E501

        Information about network vSwitches  # noqa: E501

        :return: The vds of this SystemInitSpecV3Network1.  # noqa: E501
        :rtype: list[SystemInitSpecV3Network1Vds]
        """
        return self._vds

    @vds.setter
    def vds(self, vds):
        """Sets the vds of this SystemInitSpecV3Network1.

        Information about network vSwitches  # noqa: E501

        :param vds: The vds of this SystemInitSpecV3Network1.  # noqa: E501
        :type: list[SystemInitSpecV3Network1Vds]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SystemInitSpecV3Network1, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SystemInitSpecV3Network1):
            return False
