...
class HostDiskSlotMappingRequest(object):
    ...
    def diskgroup_type(self):
        """Gets the diskgroup_type of this HostDiskSlotMappingRequest.  # noqa: E501


        :return: The diskgroup_type of this HostDiskSlotMappingRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def diskgroup_type(self, diskgroup_type):
        """Sets the diskgroup_type of this HostDiskSlotMappingRequest.


        :param diskgroup_type: The diskgroup_type of this HostDiskSlotMappingRequest.  # noqa: E501
        :type: str
        """
        allowed_values = ["1001", "1002", "2403", "2404", "2804"]  # noqa: E501
        if diskgroup_type not in allowed_values:
            raise ValueError(
                "Invalid value for `diskgroup_type` ({0}), must be one of {1}"  # noqa: E501
                .format(diskgroup_type, allowed_values)
            )
