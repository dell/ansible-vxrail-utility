...
class ClusterHostInfoV2IpSetIpv6(object):
    ...
    def __init__(self, management_ip=None, vsan_ip=None, vmotion_ip=None):  # noqa: E501
        """ClusterHostInfoV2IpSetIpv6 - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ClusterHostInfoV2IpSetIpv6, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ClusterHostInfoV2IpSetIpv6):
            return False
