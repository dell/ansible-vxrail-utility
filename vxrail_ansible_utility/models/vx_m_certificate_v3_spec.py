...
class VxMCertificateV3Spec(object):
    ...
    def vc_admin_account(self):
        ...
        VC administrator account for invoke VC API to send the new root cert to VC trust store.  # noqa: E501
    ...
    def vc_admin_password(self):
        ...
        VC administrator password for invoke VC API to send the new root cert to VC trust store.  # noqa: E501
