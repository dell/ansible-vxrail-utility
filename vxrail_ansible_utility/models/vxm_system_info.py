...
class VxmSystemInfo(object):
    ...
    def __init__(self, description=None, version=None, installed_time=None, health=None, network_connected=None, vc_connected=None, installed_components=None, cluster_type=None, number_of_host=None, is_external_vc=None, logical_view_status=None):  # noqa: E501
