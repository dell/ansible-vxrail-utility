...
class PrimaryStorageSpec(object):
    ...
    def primary_storage_type(self):
        ...
        Primary storage type that is mounted on the compute-only cluster  # noqa: E501
    ...
    def primary_storage_type(self, primary_storage_type):
        ...
        if primary_storage_type is None:
            raise ValueError("Invalid value for `primary_storage_type`, must not be `None`")  # noqa: E501
        allowed_values = ["VSAN_HCI_MESH"]  # noqa: E501
    ...
    def primary_storage_name(self):
        ...
        Name of primary storage device to where VxRail Manager will be migrated  # noqa: E501
