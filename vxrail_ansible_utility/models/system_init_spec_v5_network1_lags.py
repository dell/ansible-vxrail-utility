...
class SystemInitSpecV5Network1Lags(object):
    ...
    def __init__(self, name=None, physical_nics=None):  # noqa: E501
        """SystemInitSpecV5Network1Lags - a model defined in Swagger"""  # noqa: E501
        self._name = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SystemInitSpecV5Network1Lags, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SystemInitSpecV5Network1Lags):
            return False
