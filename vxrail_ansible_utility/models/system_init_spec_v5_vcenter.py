...
class SystemInitSpecV5Vcenter(object):
    ...
    def auto_accept_vc_cert(self):
        ...
        Whether to automatically download the vCenter root certificate. True means VxRail Manager downloads the vCenter root certificate automatically. False means users should provide the vCenter root certificate manually.  # noqa: E501
