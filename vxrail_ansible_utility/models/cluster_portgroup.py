...
class ClusterPortgroup(object):
    ...
    def __init__(self, portgroup_name=None, portgroup_type=None, portgroup_key=None, portgroup_vlan=None, vds_name=None, vds_uuid=None, vds_moid=None):  # noqa: E501
    ...
    def portgroup_name(self):
        """Gets the portgroup_name of this ClusterPortgroup.  # noqa: E501

        The name of the portgroup  # noqa: E501

        :return: The portgroup_name of this ClusterPortgroup.  # noqa: E501
        :rtype: str
        """
    ...
    def portgroup_name(self, portgroup_name):
        """Sets the portgroup_name of this ClusterPortgroup.

        The name of the portgroup  # noqa: E501

        :param portgroup_name: The portgroup_name of this ClusterPortgroup.  # noqa: E501
        :type: str
        """
        if portgroup_name is None:
            raise ValueError("Invalid value for `portgroup_name`, must not be `None`")  # noqa: E501

        self._portgroup_name = portgroup_name

    @property
    def portgroup_type(self):
        """Gets the portgroup_type of this ClusterPortgroup.  # noqa: E501

        The type of portgroup  # noqa: E501

        :return: The portgroup_type of this ClusterPortgroup.  # noqa: E501
        :rtype: str
        """
    ...
    def portgroup_type(self, portgroup_type):
        """Sets the portgroup_type of this ClusterPortgroup.

        The type of portgroup  # noqa: E501

        :param portgroup_type: The portgroup_type of this ClusterPortgroup.  # noqa: E501
        :type: str
        """
        if portgroup_type is None:
            raise ValueError("Invalid value for `portgroup_type`, must not be `None`")  # noqa: E501
