...
import six
from vxrail_ansible_utility.models.boot_device_v3 import BootDeviceV3  # noqa: F401,E501

class BootDeviceV4(BootDeviceV3):
    ...
    if hasattr(BootDeviceV3, "swagger_types"):
        swagger_types.update(BootDeviceV3.swagger_types)
    ...
    if hasattr(BootDeviceV3, "attribute_map"):
        attribute_map.update(BootDeviceV3.attribute_map)
    ...
    def __init__(self, encryption_ability=None, encryption_status=None, controller_encryption_capability=None, controller_encryption_mode=None, *args, **kwargs):  # noqa: E501
        """BootDeviceV4 - a model defined in Swagger"""  # noqa: E501
        ...
        BootDeviceV3.__init__(self, *args, **kwargs)

    @property
    def encryption_ability(self):
        """Gets the encryption_ability of this BootDeviceV4.  # noqa: E501

        Encryption ability of the boot device  # noqa: E501

        :return: The encryption_ability of this BootDeviceV4.  # noqa: E501
        :rtype: str
        """
    ...
    def encryption_ability(self, encryption_ability):
        """Sets the encryption_ability of this BootDeviceV4.

        Encryption ability of the boot device  # noqa: E501

        :param encryption_ability: The encryption_ability of this BootDeviceV4.  # noqa: E501
        :type: str
        """
    ...
    def encryption_status(self):
        """Gets the encryption_status of this BootDeviceV4.  # noqa: E501

        Encryption status of the boot device  # noqa: E501

        :return: The encryption_status of this BootDeviceV4.  # noqa: E501
        :rtype: str
        """
    ...
    def encryption_status(self, encryption_status):
        """Sets the encryption_status of this BootDeviceV4.

        Encryption status of the boot device  # noqa: E501

        :param encryption_status: The encryption_status of this BootDeviceV4.  # noqa: E501
        :type: str
        """
    ...
    def controller_encryption_capability(self):
        """Gets the controller_encryption_capability of this BootDeviceV4.  # noqa: E501

        Controller encryption capability of the boot device  # noqa: E501

        :return: The controller_encryption_capability of this BootDeviceV4.  # noqa: E501
        :rtype: str
        """
    ...
    def controller_encryption_capability(self, controller_encryption_capability):
        """Sets the controller_encryption_capability of this BootDeviceV4.

        Controller encryption capability of the boot device  # noqa: E501

        :param controller_encryption_capability: The controller_encryption_capability of this BootDeviceV4.  # noqa: E501
        :type: str
        """
    ...
    def controller_encryption_mode(self):
        """Gets the controller_encryption_mode of this BootDeviceV4.  # noqa: E501

        Controller encryption mode of the boot device  # noqa: E501

        :return: The controller_encryption_mode of this BootDeviceV4.  # noqa: E501
        :rtype: str
        """
    ...
    def controller_encryption_mode(self, controller_encryption_mode):
        """Sets the controller_encryption_mode of this BootDeviceV4.

        Controller encryption mode of the boot device  # noqa: E501

        :param controller_encryption_mode: The controller_encryption_mode of this BootDeviceV4.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BootDeviceV4, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BootDeviceV4):
            return False
