...
class DiskGroupTypeAndDesInfo(object):
    ...
    def __init__(self, type=None, description=None):  # noqa: E501
        """DiskGroupTypeAndDesInfo - a model defined in Swagger"""  # noqa: E501
        self._type = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DiskGroupTypeAndDesInfo, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DiskGroupTypeAndDesInfo):
            return False
