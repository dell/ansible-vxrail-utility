...
class WitnessBasicInfoV1(object):
    ...
    def os_version(self):
        ...
        Operation system version of the witness  # noqa: E501
    ...
    def witness_management(self):
        ...
        Witness manager firmware version of the witness  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(WitnessBasicInfoV1, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WitnessBasicInfoV1):
            return False
