...
class CustomerSuppliedHostInfo(object):
    ...
    def __init__(self, management_ip=None, current_root_password=None):  # noqa: E501
        """CustomerSuppliedHostInfo - a model defined in Swagger"""  # noqa: E501
    ...
    def current_root_password(self):
        ...
        User-specified host root account password. If this parameter is not provided, the default ESXi host root password is set.   # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CustomerSuppliedHostInfo, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CustomerSuppliedHostInfo):
            return False
